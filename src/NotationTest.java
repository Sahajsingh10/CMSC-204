...
public class NotationTest {
	...
	@Test
	public void testComplexConvertInfixToPostfix() throws QueueOverflowException, StackOverflowException,
			StackUnderflowException, InvalidNotationFormatException {
		String postfixResult = Notation.convertInfixToPostfix(complexInfix);
		assertEquals(complexPostfix, postfixResult);
	}

	@Test
	public void testIntermediateConvertInfixToPostfix() throws QueueOverflowException, StackOverflowException,
			StackUnderflowException, InvalidNotationFormatException {
	...
	@Test
	public void testEasyConvertInfixToPostfix() throws QueueOverflowException, StackOverflowException,
			StackUnderflowException, InvalidNotationFormatException {
	...
	public void testInvalidInfixExpression()
			throws QueueOverflowException, StackOverflowException, StackUnderflowException {
		try {

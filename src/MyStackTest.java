...
public class MyStackTest {
	...
	public Double g = 2.5, t = 6.8, z = 4.7, l = 6.7, r = 5.0, m = 9.0;
	...
	public void testPopStudent() {
		try {
			assertEquals(z, doubleS.pop());
			assertEquals(t, doubleS.pop());
	...
	public void testToStringStudent() throws StackOverflowException {
		...
		assertEquals("2.56.84.7", doubleS.toString());
		doubleS.push(l);
		assertEquals("2.56.84.76.7", doubleS.toString());
		doubleS.push(r);
		assertEquals("2.56.84.76.75.0", doubleS.toString());
	}
